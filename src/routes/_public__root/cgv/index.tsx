            ...
            <div className="mx-auto max-w-3xl">
              <LegalSection title="1. Objet">
                <p>
                  ...
                  les relations contractuelles entre Pasio Padel Club et ses
                  clients pour toute réservation de court de padel et services
                  associés.
                </p>
                <p>
              ...
              <LegalSection title="3. Réservation">
                <p>
                  ...
                  internet, l&apos;application mobile &quot;Pasio Padel
                  Club&quot; ou par téléphone au{' '}
                  <a
                ...
                <p>
                  Toute réservation est ferme et définitive dès sa confirmation
                  et le paiement effectué. Un email de confirmation est envoyé
                  au client.
                </p>
              ...
              <LegalSection title="4. Tarifs et paiement">
                <p>
                  Les tarifs sont indiqués en euros TTC et peuvent être modifiés
                  à tout moment. Les tarifs applicables sont ceux en vigueur au
              ...
              <LegalSection title="5. Annulation et remboursement">
                ...
                <ul className="ml-6 list-disc space-y-2">
                  <li>
                    Annulation plus de 24 heures avant le créneau :
                ...
                <p>
                  ...
                  maintenance imprévue), le client sera intégralement remboursé
                  ou pourra reporter sa réservation sans frais.
                </p>
              </LegalSection>
              ...
              <LegalSection title="6. Règles d'utilisation des courts">
                ...
                <ul className="ml-6 list-disc space-y-2">
                  ...
                  <li>
                    Adopter un comportement respectueux envers les autres
                    joueurs et le personnel
                  </li>
                </ul>
                <p className="mt-4">
                  En cas de dégradation volontaire du matériel ou des
                  installations, le client sera tenu responsable des
                  réparations.
                </p>
              </LegalSection>
              ...
              <LegalSection title="7. Responsabilité">
                ...
                <p>
                  ...
                  de perte d&apos;objets personnels dans l&apos;enceinte du
                  club.
                </p>
              </LegalSection>
              ...
              <LegalSection title="8. Données personnelles">
                <p>
                  Les données personnelles collectées lors de la réservation
                  sont traitées conformément à notre politique de
                  confidentialité et au RGPD. Elles sont utilisées uniquement
                  pour la gestion des réservations et la communication avec nos
                  clients.
                </p>
                <p>
              ...
              <LegalSection title="9. Réclamations">
                ...
                <p>
                  Nous nous engageons à traiter toute réclamation dans un délai
              ...
              <LegalSection title="10. Droit applicable et litiges">
                ...
                <p>
                  À défaut d&apos;accord amiable, les tribunaux compétents
                  seront ceux du ressort du siège social de Pasio Padel Club.
                </p>
              </LegalSection>
